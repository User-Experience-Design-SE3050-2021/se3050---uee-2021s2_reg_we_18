        ...
        <View style={globalStyles.container}>
          ...
          >
            ...
            <RadioButton
              value="reconditioned"
              color="#076AE0"
              status={condition === "reconditioned" ? "checked" : "unchecked"}
              onPress={() => setCondition("reconditioned")}
              style={{ flex: 1 }}
            />
          ...
          <Picker
            selectedValue={
              ad && ad.category ? ad.category : "Select Spare Part Category"
            }
            style={globalStyles.input}
            onValueChange={(itemValue, itemIndex) =>
              setAd({ ...ad, category: itemValue })
            }
          >
          ...
          >
            <RadioButton
              value="yes"
              status={ad && ad.delivery ? "checked" : "unchecked"}
              color="#076AE0"
              onPress={() => setAd({ ...ad, delivery: true })}
              style={{ flex: 1 }}
            />
            <Text>Yes</Text>
            <RadioButton
              ...
              status={ad && !ad.delivery ? "checked" : "unchecked"}
              color="#076AE0"
              onPress={() => setAd({ ...ad, delivery: false })}
              style={{ flex: 1 }}
            />
            <Text>No</Text>
          </View>
