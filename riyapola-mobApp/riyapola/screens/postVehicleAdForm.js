...
export default function postVehicleAdForm({ navigation }) {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            await axios.get("https://riyapola.herokuapp.com/category").then((res) =>{
                if(res.data){
        ...
        <View style={globalStyles.container}>
          ...
          >
            <RadioButton
              value="registered"
              color="#076AE0"
              status={condition === "registered" ? "checked" : "unchecked"}
              onPress={() => setCondition("registered")}
              style={{ flex: 1 }}
            />
            ...
            <RadioButton
              value="unregistered"
              color="#076AE0"
              status={condition === "unregistered" ? "checked" : "unchecked"}
              onPress={() => setCondition("unregistered")}
              style={{ flex: 1 }}
            />
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              <Picker
                ...
                selectedValue={ad && ad.category ? ad.category : null}
                onValueChange={(text) => setAd({ ...ad, category: text })}
              >
                ...
                {categories
                  ? categories
                      ...
                      .map((val) => (
                        <Picker.Item
                          label={val.mainName}
                          value={val.mainName.toLowerCase()}
                        />
                      ))
                  : null}
              </Picker>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Picker
                style={globalStyles.select}
                selectedValue={ad && ad.make ? ad.make : null}
                onValueChange={(text) => setAd({ ...ad, make: text })}
              >
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              <Picker
                style={globalStyles.select}
                selectedValue={ad && ad.model ? ad.model : null}
                onValueChange={(text) => setAd({ ...ad, model: text })}
              >
            ...
            <View style={globalStyles.label}>
              ...
              <Picker
                style={globalStyles.select}
                selectedValue={ad && ad.bodyType ? ad.bodyType : null}
                onValueChange={(text) => setAd({ ...ad, bodyType: text })}
              >
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              >
                ...
                {dist
                  ? dist.map((dist) => {
                      return <Picker.Item label={dist} value={dist} />;
                    })
                  : null}
              </Picker>
            </View>
            <View style={{ flex: 1 }}>
              ...
              <TextInput
                ...
                style={globalStyles.input}
                onChangeText={(text) => setAd({ ...ad, engineCapacity: text })}
              />
            </View>
          </View>
          <View
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              <Picker
                style={globalStyles.select}
                selectedValue={ad && ad.transmission ? ad.transmission : null}
                onValueChange={(text) => setAd({ ...ad, transmission: text })}
              >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Picker
                style={globalStyles.select}
                selectedValue={ad && ad.fuelType ? ad.fuelType : null}
                onValueChange={(text) => setAd({ ...ad, fuelType: text })}
              >
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              >
                <RadioButton
                  value="negotiable"
                  status={ad && ad.negotiable ? "checked" : "unchecked"}
                  color="#076AE0"
                  onPress={() => setAd({ ...ad, negotiable: !ad.negotiable })}
                />
            ...
            <View style={{ flex: 1 }}>
              ...
              <TextInput
                ...
                keyboardType="numeric"
                style={globalStyles.input}
                onChangeText={(text) => setAd({ ...ad, mileage: text })}
              />
            </View>
          </View>
          <View>
                  ...
                  pics.map((image) => (
                    ...
                    >
                      <Icon
                        name="clear"
                        color="red"
                        onPress={removeIcon.bind(this, { base64: image })}
                        size={36}
                      />
                      <Image
          ...
          <List.Section
            style={{ backgroundColor: "#fff", borderRadius: 12, elevation: 5 }}
          >
            {phones
              ? phones.map((phone) => {
                  return (
                    <List.Item
                      ...
                      left={() => <List.Icon color="#076AE0" icon="phone" />}
                      right={() => (
                        <List.Icon color="red" icon="minus-circle" />
                      )}
                      onPress={() =>
            ...
            >
              <Text style={{ color: "#076AE0", marginEnd: 5 }}>
