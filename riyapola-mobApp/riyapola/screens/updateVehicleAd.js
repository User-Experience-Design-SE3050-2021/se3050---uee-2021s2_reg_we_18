    ...
    return (
        <ScrollView>
            <View style={globalStyles.container}>
                <Text style={globalStyles.topicForm}>Update Your Vehicle Ad</Text>
                ...
                <TextInput placeholder="Advertisement Title" value={ad && ad.title ? ad.title : null} style={globalStyles.input} onChangeText={(text) => setAd({ ...ad, title: text })} />
                ...
                <TextInput style={globalStyles.textarea} value={ad && ad.description ? ad.description : null} placeholderTextColor="grey" numberOfLines={10} multiline={true} placeholder='Enter your description' onChangeText={(text) => setAd({ ...ad, description: text })} />
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', flex: 1 }} >
                    <View style={{ flex: 1 }}>
                ...
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', flex: 1 }} >
                    <View style={{ flex: 1 }}>
                        ...
                        <TextInput placeholder="Enter Price(Rs.)" keyboardType="numeric" style={globalStyles.input} value={ad && ad.price ? ad.price.toString() : null} onChangeText={(text) => setAd({ ...ad, price: text })} />
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <TextInput placeholder="Enter Mileage(km)" keyboardType="numeric" style={globalStyles.input} value={ad && ad.mileage ? ad.mileage : null} onChangeText={(text) => setAd({ ...ad, mileage: text })} />
                    </View>
                </View>
                <View >
